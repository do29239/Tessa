                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <tr><td><strong>Saloon Name:</strong></td><td>{{ $request->saloon_name ?? '—' }}</td></tr>
                            <tr><td><strong>Saloon City:</strong></td><td>{{ $request->saloon_city ?? '—' }}</td></tr>
                            <tr><td><strong>Saloon Address:</strong></td><td>{{ $request->saloon_address ?? '—' }}</td></tr>
                            <tr><td><strong>Saloon Phone:</strong></td><td>{{ $request->saloon_phone ?? '—' }}</td></tr>
                            <tr><td><strong>Message:</strong></td><td>{!! nl2br(e($request->message ?? '')) !!}</td></tr>
                        </table>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card card-half">
                    <div class="card-body">
                        <h2>User Details</h2>
                        <table class="table table-bordered">
                            <tr><td><strong>First Name:</strong></td><td>{{ $request->user?->first_name ?? '—' }}</td></tr>
                            <tr><td><strong>Last Name:</strong></td><td>{{ $request->user?->last_name ?? '—' }}</td></tr>
                            <tr><td><strong>City:</strong></td><td>{{ $request->user?->city ?? '—' }}</td></tr>
