    ...
    <section class="login-area ptb-100">
        ...
        <div class="login-content">
            ...
            <form method="POST" action="{{ route('register') }}" class="login-form">
                ...
                <!-- Stylist Checkbox -->
                <div class="form-group form-check register">
                    <input class="form-check-input" id="is_stylist" type="checkbox" name="is_stylist" value="1" {{ old('is_stylist') ? 'checked' : '' }}>
                    <label class="sub-title form-check-label mb-0" for="is_stylist">
